...
- Display: IBM Plex Sans JP, weight 700, style normal
- Body: IBM Plex Sans JP, weight 400
...
- IBM Plex Sans JP UI and Geist Mono measurements
...
```json
{
  ...
  "font": {
    "display": { "$value": "IBM Plex Sans JP", "$type": "fontFamily" },
    "body": { "$value": "IBM Plex Sans JP", "$type": "fontFamily" },
