...
- Display: M PLUS 2, weight 700, style normal
- Body: M PLUS 2, weight 400
...
- M PLUS 2 UI and Geist Mono measurements
...
```json
{
  ...
  "font": {
    "display": { "$value": "M PLUS 2", "$type": "fontFamily" },
    "body": { "$value": "M PLUS 2", "$type": "fontFamily" },
