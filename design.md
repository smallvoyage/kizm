...
- Inter Latin and numerals with LINE Seed JP Japanese text
...
```json
{
  ...
  "font": {
    "display": { "$value": ["Inter", "LINE Seed JP"], "$type": "fontFamily" },
    "body": { "$value": ["Inter", "LINE Seed JP"], "$type": "fontFamily" },
    "outlier": { "$value": "Inter", "$type": "fontFamily" }
  },
  "space": {
