...
test(
  "320px dashboard matches the normal-state snapshot",
  {
    tag: "@visual",
  },
  async ({ page }, testInfo) => {
...
test(
  "390px dashboard matches the normal-state snapshot",
  {
    tag: "@visual",
  },
  async ({ page }, testInfo) => {
...
test(
  "390px body composition chart matches every metric snapshot",
  {
    tag: "@visual",
  },
  async ({ page }, testInfo) => {
